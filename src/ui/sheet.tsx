...
export const sheetVariants = cva({
  base: "fixed z-50 gap-4 bg-background p-6 shadow-lg transition ease-in-out data-expanded:animate-in data-closed:animate-out data-expanded:duration-200 data-closed:duration-200",
  variants: {
    side: {
